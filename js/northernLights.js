...
var BRUSH_MIN_SCALE_Y = 0.02
var BRUSH_MAX_SCALE_Y_VARIANCE = 0.5
var BRUSH_MAX_ALPHA_VARIANCE = 0.7
var BRUSH_MAX_ANIM_TIME = 7000
var BRUSH_MIN_ANIM_TIME = 1500
var BRUSH_MAX_Z_ANIM_TIME = 80000
var BRUSH_MIN_Z_ANIM_TIME = 58000
var BRUSH_ALPHA_DROPOFF = 0.07
var MOUSE_X_OFFSET = 50
var MOUSE_Y_OFFSET = 25
var mouseXPercentage = 0.5
var mouseYPercentage = 0.5
...
Brush.prototype = {
	draw: function(ctx) {
		...
		if (!this.noScale) {
			...
			var scaleX = this.z * this.scaleXMod + 0.5
		} else {
			var scaleY = this.scaleYMod + BRUSH_MIN_SCALE_Y
			var scaleX = this.scaleXMod + 0.5
		}
	...
	updatePosition: function() {
		if (!this.startTime) this.startTime = new Date().getTime() - 20000
		var now = new Date().getTime()
		var deltaTime = now - this.startTime
...
NorthernLights.prototype = {
	start: function() {
		...
		;(function anim() {
			...
			if (_this.running) requestAnimationFrame(anim)
		})()
	},
	pause: function() {
		this.running = false
...
var grad = gradCtx.createLinearGradient(
...
var grad2 = gradCtx.createLinearGradient(
	window.innerWidth * 0.5,
